...
echo %VENV_PATH%\Scripts\pyinstaller main.spec --noconfirm --clean
if %ERRORLEVEL% neq 0 (
...
if exist "dist\main\main.exe" (
    echo [OK] Build successful: main.exe found
...
echo Please copy the entire dist\main directory to the target machine to run
echo.
pause
